...
configChoosenModel = "yolov5"# "CenterNet"
...
class MainWindow(QtWidgets.QMainWindow, ui_main_window.Ui_MainWindow):
    ...
    def run_cut_and_detect(self):
        ...
        self.img_dir = cut_and_detect(self,chosen_model=configChoosenModel)
    ...
    def check_save_dir(self):
        if self.save_dir is None:
            QtWidgets.QMessageBox.information(self.centralwidget, 'Attention', 'Please select a save path')
    ...
    def save_img(self):
        ...
        QtWidgets.QMessageBox.warning(self, "Saved successfully", "Saved successfully！", QtWidgets.QMessageBox.Yes)
    ...
    def help_listener(self):
        QtWidgets.QMessageBox.information(self.centralwidget, 'help', config.help_text) #后续可以进入config.help_text修改
    ...
    def closeEvent(self, e):
        reply = QtWidgets.QMessageBox.question(self, 'Confirm exit', "Do you want to exit the program？", QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No, QtWidgets.QMessageBox.No)
